...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<hgroup>
		  <a class="logo-ribbon" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.png"></a>
  ...
  <nav id="lower-navigation" class="main-navigation" role="navigation">
      <h3 class="menu-toggle"><?php _e( 'Organizations', 'twentytwelve' ); ?></h3>
