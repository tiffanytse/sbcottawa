<?php
/**
 * Template Name: NICCC Blog Page Template
 *
  ...
  <div id="primary" class="site-content">
    <div id="content" role="main">
      <div class="event-listing">
        <h1>Upcoming Events for National Irish Canadian Cultural Centre</h1>
        <br>
        <?php
      ...
      <div class="niccc-items post-content">
        <?php query_posts( 'category_name=niccc' );
