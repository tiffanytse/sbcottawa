<?php
/**
 * Template Name: Brigid's Well Blog Page Template
 *
  ...
  <div id="primary" class="site-content">
    <div id="content" role="main">
      <div class="event-listing">
        <h1>Upcoming Events for Brigid's Well</h1>
        <br>
        <?php
         $events = eo_get_events(array(
                 ...
                 'event-category'=>'brigids-well-event',
            ));
      ...
      <div class="niccc-items post-content">
        <?php query_posts( 'category_name=brigids-well' );
